...
public class LocalMusicUtils {
    ...
    public static String queryMusicById(int musicId) {
        String result = null;
        Cursor cursor = App.appContext.getContentResolver().query(
...
//        Cursor cursor = App.appContext.getContentResolver().query(MediaStore.Audio.Media.EXTERNAL_CONTENT_URI, null,
//                null,null,MediaStore.Audio.Media.DEFAULT_SORT_ORDER);
    ...
    private static String getAlbumImage(int albumId) {
        ...
        Cursor cursor = null;
        try {
            cursor = App.appContext.getContentResolver().query(
